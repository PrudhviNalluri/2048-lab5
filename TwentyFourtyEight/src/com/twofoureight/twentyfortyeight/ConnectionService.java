...
//variables declaration
	...
	private GameGestureDetector gd;
    	   ...
    	   try {
    		   ...
    		   if(dataPoints.size()>6){
	    		   if(t.test(returnType)=="left"){
	    			   	...
	    			   	gd.onFling(null, null, 1, 0);
	    		   }
	    		   else	if(t.test(returnType)=="right"){
		    			   	sendPatternTrigger("right");
		    			   	gd.onFling(null, null, 2, 0);
		    		
	    			   	}
	    			   	else if(t.test(returnType)=="up"){
			    			   	sendPatternTrigger("up");
			    			   	gd.onFling(null, null, 3, 0);
	    			   	
	    		   }
	    			   	else if(t.test(returnType)=="down"){
		    			   	sendPatternTrigger("down");
		    			   	gd.onFling(null, null, 4, 0);
